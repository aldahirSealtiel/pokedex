...
public class PokemonListAdapter extends ArrayAdapter<Pokemon> {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            holder.pokemonIdTextView = (TextView)
                                    convertView.findViewById(R.id.pokemon_list_item_id_textView);
            holder.pokemonNameTextView = (TextView)
                                    convertView.findViewById(R.id.pokemon_list_item_name_textView);
            holder.pokemonTypeImageView = (ImageView)
                                    convertView.findViewById(R.id.pokemon_list_item_type_image);
        ...
        holder.pokemonNameTextView.setText(String.valueOf(pokemon.getName()));
